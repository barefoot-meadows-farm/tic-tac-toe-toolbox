        ...
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center mb-12 animate-fade-in [animation-delay:300ms]">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Play Classic</h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                The timeless game of X's and O's, redesigned with beautiful animations
        ...
        <section className="py-16 md:py-24 bg-muted/30">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Discover unique twists on the classic game, each with its own rules and challenges.
              </p>
            </div>
